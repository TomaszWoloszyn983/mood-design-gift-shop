...
```html
    ...
    {% endif %}
```
This conditional statement checks whether the file contains associated image or not. And if the image doesn;t contain one it dispalys the default image.
