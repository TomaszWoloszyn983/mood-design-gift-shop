...
class UserProfile(models.Model):
    """
    A user profile model contains information that are 
    saved and used as default information in future Orders.
    """
...
def create_or_update_user_profile(sender, instance, created, **kwargs):
    """
    Create a user profile or update already existing profile.
    """
    if created:
